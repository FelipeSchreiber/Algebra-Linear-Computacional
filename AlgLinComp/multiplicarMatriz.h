...
#define NUMERO_MAXIMO_LINHAS1 6 //caso for fazer minimos quadrados esse valor deve ser 2, senao a quantidade de linhas da matriz de entrada
#define NUMERO_MAXIMO_COLUNAS1 6//quantidade de colunas da matriz de entrada
...
void MultiplicarMatrizVetor(float **matriz1, float *matriz2, float *matrizResultado);
